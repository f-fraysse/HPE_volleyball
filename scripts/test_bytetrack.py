...
OUT_VIDEO_FILE = 'test_det-S_pose-S_track-0508.mp4'
resize_output = True
resize_width = 960
resize_height = 540
...
# Data Paths
record_results = True
OUT_H5_FILE = "test_det-S_pose-S_track-0508.h5"

# Detection and tracking models
RTMDET_MODEL = 'rtmdet-s-640.onnx'
RTMPOSE_MODEL = 'rtmpose-s-256-192.onnx'
...
while cap.isOpened():
    ...
    # Timing info
    disp_time = time.time()
    det_duration = (det_time - start_time) * 1000
    ...
    img_show = cv2.putText(img_show, f'det: {det_duration: .2f} ms', (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 0), 2)
    img_show = cv2.putText(img_show, f'track: {track_duration: .2f} ms', (10, 70), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 0), 2)
    img_show = cv2.putText(img_show, f'pose: {pose_duration: .2f} ms', (10, 90), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 0), 2)
    img_show = cv2.putText(img_show, f'hdf5: {hdf5_duration: .2f} ms', (10, 110), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 0), 2)
    img_show = cv2.putText(img_show, f'disp: {disp_duration: .2f} ms', (10, 130), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 0), 2)
